...
class BertForSeq2SeqConfig(BertConfig):
    ...
    def __init__(self, label_smoothing=0.1, source_type_id=0, target_type_id=1, **kwargs):
        ...
        self.source_type_id = source_type_id # 0
        self.target_type_id = target_type_id # 1
    ...
    def from_exist_config(
            ...
            layoutlm_only_layout_flag=False
    ):
        ...
        return cls(label_smoothing=label_smoothing, **kwargs)  # 收集参数后创建对象
